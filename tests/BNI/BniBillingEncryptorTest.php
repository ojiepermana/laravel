...
class BniBillingEncryptorTest extends TestCase
{
    ...
    {
        $result = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, $this->secret_key);
    ...
    {
        $first  = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, $this->secret_key);
        sleep(1);
        $second = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, $this->secret_key);
    ...
    {
        $result = BniBillingEncryptor::encryptPayload([], $this->client_id, $this->secret_key);
    ...
    {
        $first  = BniBillingEncryptor::encryptPayload($this->sampleData, '001', $this->secret_key);
        $second = BniBillingEncryptor::encryptPayload($this->sampleData, '002', $this->secret_key);
    ...
    {
        $first  = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, 'secret_a');
        $second = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, 'secret_b');
    ...
    {
        $hashed = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, $this->secret_key);
        $result = BniBillingEncryptor::decryptPayload($hashed, $this->client_id, $this->secret_key);
    ...
    public function test_roundtrip_with_minimal_data(): void
    {
        ...
        $hashed = BniBillingEncryptor::encryptPayload($data, $this->client_id, $this->secret_key);
        $result = BniBillingEncryptor::decryptPayload($hashed, $this->client_id, $this->secret_key);
    ...
    {
        $hashed = BniBillingEncryptor::encryptPayload([], $this->client_id, $this->secret_key);
        $result = BniBillingEncryptor::decryptPayload($hashed, $this->client_id, $this->secret_key);
    ...
    {
        $hashed = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, $this->secret_key);
        $result = BniBillingEncryptor::decryptPayload($hashed, 'WRONG_ID', $this->secret_key);
    ...
    {
        $hashed = BniBillingEncryptor::encryptPayload($this->sampleData, $this->client_id, $this->secret_key);
        $result = BniBillingEncryptor::decryptPayload($hashed, $this->client_id, 'wrong_secret_key');
    ...
    {
        $result = BniBillingEncryptor::decryptPayload('ini-bukan-hash-valid', $this->client_id, $this->secret_key);
    ...
    {
        $result = BniBillingEncryptor::decryptPayload('', $this->client_id, $this->secret_key);
