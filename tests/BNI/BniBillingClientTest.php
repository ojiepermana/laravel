...
class BniBillingClientTest extends TestCase
{
    ...
    private function makeService(): BniBillingClient
    {
    ...
    private function fakeSuccessResponse(array $data): array
    {
        return [
            'status' => '000',
            'data'   => BniBillingEncryptor::encryptPayload($data, $this->clientId, $this->secretKey),
        ];
    }
    ...
    public function test_create_sends_correct_encrypted_payload(): void
    {
        ...
        Http::assertSent(function ($request) {
            ...
            $decrypted = BniBillingEncryptor::decryptPayload($body['data'], $this->clientId, $this->secretKey);
    ...
    public function test_create_with_sendSms_uses_createbillingsms_type(): void
    {
        ...
        Http::assertSent(function ($request) {
            $decrypted = BniBillingEncryptor::decryptPayload($request->data()['data'], $this->clientId, $this->secretKey);
